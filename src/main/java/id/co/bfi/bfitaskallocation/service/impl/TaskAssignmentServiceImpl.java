...
public class TaskAssignmentServiceImpl implements TaskAssignmentService {
  ...
  public TaskAssignmentResponse createTaskAssignment(CreateTaskAssignmentRequest createTaskAssignment) {
    ...
    log.debug("New task assignment record created !");
  ...
  public TaskAssignmentResponse updateStatusTaskAssignment(Long id, UpdateTaskAssignmentRequest updateTaskAssignmentRequest) {
    ...
    if (taskAssignment != null) {
      taskAssignment.setTaskStatus(updateTaskAssignmentRequest.getTaskStatus());
      taskAssignmentRepository.save(taskAssignment);
      log.debug("New task assignment record updated !");
    }
    return TaskAssignmentResponse.builder()
        .id(taskAssignment.getId())
        .transactionCode(taskAssignment.getTransactionCode())
